    ...
    private ChainBuilder Open_product(String productType, String ProductNumber, String saveValueIn,
        ...
        return exec(
                http("Step_" + requestNumber + "_Open_product" + productType)
                        ...
                        .headers(headers_0)
                        .check(regex("post_id.:\"(.{1,4})\",").saveAs("extractedProductId" + saveValueIn))
                        .check(status().is(200)))
                .pause(1);
    }
                    ...
                    exec(
                            ...
                            randomSwitch().on(
                                    new Choice.WithWeight(50.0, exec(
                                            Navigate_to_("#{object_type_1}", "4"),
                                            Open_product("#{specific_type_1}", "#{product_number_1}", "2", "5"),
                                            add_product("#{object_type_1}"))),
                                    new Choice.WithWeight(50.0, exec(
                                            Navigate_to_("#{object_type_2}", "4"),
                                            Open_product("#{specific_type_2}", "#{product_number_2}", "2", "5"),
                            ...
                            randomSwitch().on(
                                    ...
                                    new Choice.WithWeight(40.0, exec(
                                            // Navigate_to_cart,
                                            Navigate_to_cart,
                                            // Navigate_to_checkout directly,
                                            Navigate_to_("checkout", "12"),
                                            Fill_out_form,
                                            // Place_order,
                                            Place_order)),
                                    new Choice.WithWeight(30.0, exec(
                                            Navigate_to_("thank-you", "13"))))));
